...
public class TransactionControllerXmlTest extends TransactionProcessorAbstract {
    ...
    @Test
    public void getXmlTransaction_givenValidXmlTransactionData_returnsStatusCode200() {
        final String URL = getFullUrl(WebResourceURIConstants.XML_TRANSACTION_PROCESSOR, port);
        TransactionRequestDto transactionRequestDto = getTransactionRequestDto(getValidXmlTransactions());
    ...
    @Test
    public void getXmlTransaction_givenValidXmlTransactionData_returnsHttpStatusOk() {
        final String URL = getFullUrl(WebResourceURIConstants.XML_TRANSACTION_PROCESSOR, port);
        TransactionRequestDto transactionRequestDto = getTransactionRequestDto(getValidXmlTransactions());
        ResponseEntity<Object> responseEntity = restTemplate.postForEntity(URL,
                transactionRequestDto
    ...
    @Test
    public void getXmlTransaction_givenTransactionDataEmptyWhenInputStreamIsNull_returnsStatusCode400() {
        final String URL = getFullUrl(WebResourceURIConstants.XML_TRANSACTION_PROCESSOR, port);
        TransactionRequestDto transactionRequestDto = getTransactionRequestDto(getNullXmlTransactions());
        ResponseEntity<Object> responseEntity = restTemplate.postForEntity(URL,
                transactionRequestDto
                , Object.class);
    ...
    @Test
    public void getXmlTransaction_givenTransactionDataEmptyWhenInputStreamIsNull_returnsHttpStatusBadRequest() {
        final String URL = getFullUrl(WebResourceURIConstants.XML_TRANSACTION_PROCESSOR, port);
        TransactionRequestDto transactionRequestDto = getTransactionRequestDto(getNullXmlTransactions());
        ResponseEntity<Object> responseEntity = restTemplate.postForEntity(URL,
                transactionRequestDto
    ...
    @Test
    public void getXmlTransaction_givenTransactionDataEmptyWhenInputStreamIsNull_returnsTransactionCannotBeEmptyErrorMessage() {
        final String URL = getFullUrl(WebResourceURIConstants.XML_TRANSACTION_PROCESSOR, port);
    ...
    @Test
    public void getXmlTransaction_givenRequestBodyNull_returnsHttpStatus415() {
        final String URL = getFullUrl(WebResourceURIConstants.XML_TRANSACTION_PROCESSOR, port);
    ...
    @Test
    public void getXmlTransaction_givenNullTransactionData_returnsBadRequestErrorMessage() {
        final String URL = getFullUrl(WebResourceURIConstants.XML_TRANSACTION_PROCESSOR, port);
    ...
    @Test
    public void getXmlTransaction_givenValidXmlTransactionData_returnsSizeThree() {
        final String URL = getFullUrl(WebResourceURIConstants.XML_TRANSACTION_PROCESSOR, port);
        TransactionRequestDto transactionRequestDto = getTransactionRequestDto(getValidXmlTransactions());
        ResponseEntity<Object> responseEntity = restTemplate.postForEntity(URL,
                transactionRequestDto
    ...
    @Test
    public void getXmlTransaction_givenValidXmlTransactionData_returnsExpectedList() {
        final String URL = getFullUrl(WebResourceURIConstants.XML_TRANSACTION_PROCESSOR, port);
        TransactionRequestDto transactionRequestDto = getTransactionRequestDto(getValidXmlTransactions());
